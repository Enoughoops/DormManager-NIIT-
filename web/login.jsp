<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import="com.enough.model.Admin" %>
<%@ page import="com.enough.model.DormManager" %>
<%@ page import="com.enough.model.Student" %>
<%
...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading"><font color="gray">NIIT宿舍管理系统</font></h2>
		...
		<p align="center" style="padding-top: 15px;">CopyRight NIIT  <a href="http://www.niit.com.cn" target="_blank">http://www.niit.com.cn</a></p>
      </form>
</div>
</body>
</html>