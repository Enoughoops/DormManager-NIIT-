...
import com.enough.model.Admin;
import com.enough.model.DormManager;
import com.enough.model.Student;
...
public final class mainAdmin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<!--    使用了bootstrap class是决定div的重要属性-->\r\n");
      ...
      out.write("\t\t\t\t\t<li><a href=\"dormManager?action=list\"><i class=\"icon-chevron-right\"></i>宿舍管理员管理</a></li>\r\n");
      out.write("\t\t\t\t\t<li><a href=\"student?action=list\"><i class=\"icon-chevron-right\"></i>学生管理</a></li>\r\n");
      out.write("\t\t\t\t\t<li><a href=\"dormBuild?action=list\"><i class=\"icon-chevron-right\"></i>宿舍楼管理</a></li>\t\t\t\t\t\r\n");
